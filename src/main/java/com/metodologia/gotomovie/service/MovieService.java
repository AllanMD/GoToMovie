...
public class MovieService {
    ...
    public SearchResults getPopularMovies (){
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.getForObject("https://api.themoviedb.org/3/movie/popular?api_key=8d7db92be0746d3da167842d227f2f64&language=en-US&page=1", SearchResults.class);
    }
}
